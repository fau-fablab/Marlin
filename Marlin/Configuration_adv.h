...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_XY_FEEDRATE 50          // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
  #define PAUSE_PARK_Z_FEEDRATE 5             // Z axis feedrate in mm/s (not used for delta printers)
  #define PAUSE_PARK_RETRACT_FEEDRATE       // Initial retract feedrate in mm/s
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH 780   // Unload filament length from hotend in mm
  ...
  #define FILAMENT_CHANGE_LOAD_LENGTH -95       // Load filament length over hotend in mm
