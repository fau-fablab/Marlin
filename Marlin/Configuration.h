...
#define STRING_CONFIG_H_AUTHOR "Wörk done by Lord BOfH and Toni" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Holzdrucker"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.7402, 78.7402, 533.3333333, 865,887}  // default steps per unit for Ultimaker
...
#define DEFAULT_NOMINAL_FILAMENT_DIA 2.90  //Enter the diameter (in mm) of the filament generally used (3.0 mm or 1.75 mm) - this is then used in the slicer software.  Used for sensor reading validation
